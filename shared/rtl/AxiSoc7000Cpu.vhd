...
begin
    ...
    U_CPU : AxiSoc7000CpuCore
        port map(
            ...
            -- axi_dma_aruser does not exist for AXI3 but we don't use it anyways
            ...
            -- axi_dma_awuser does not exist for AXI3 but we don't use it anyways
            ...
            axi_dma_wid(5 downto 0)     => (others => '0'),
