...
# Create the project
petalinux-create project --template zynq --name $name
cd $name
...
cp -f $axi_soc_7000_core/petalinux-apps/rogue.bb project-spec/meta-user/recipes-apps/rogue/rogue.bb
...
cp -rf $axi_soc_7000_core/petalinux-apps/roguetcpbridge project-spec/meta-user/recipes-apps/.
...
cp -rf $axi_soc_7000_core/petalinux-apps/startup-app-init project-spec/meta-user/recipes-apps/.
